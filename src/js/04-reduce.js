...
// const totalSalary = Object.values(salary).reduce((sum, elem) => {
//   return sum + elem;
// }, 0);
...
const totalTimePlayed = players.reduce((total, player, i, arr) => {
  return total + player.timePlayed / arr.length;
}, 0);
